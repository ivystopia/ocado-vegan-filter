...
| Live layouts | `tools/check_ocado_userscript_scenarios.py`: temporary Firefox at verified viewport widths, initial/scrolled product states, hit targets, and screenshots. |
